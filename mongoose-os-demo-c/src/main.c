/* Origem: clone direto do repositório oficial
 * https://github.com/mongoose-os-apps/demo-c (via `mos clone`), não
 * modificado nesta colaboração - usado tal e qual para testar se o
 * Mongoose OS ainda compila/grava/arranca hoje (secção 9 do relatório).
 */
#include "mgos.h"
#include "mgos_mqtt.h"
