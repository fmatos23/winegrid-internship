/* Origem: cópia verbatim do repositório oficial do Zephyr (v3.7.0) - ver ORIGEM.md nesta pasta para o link exato e a autoria original de cada ficheiro. Não escrito nem modificado nesta colaboração. */
